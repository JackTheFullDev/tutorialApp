This is the first version of the tutorial application has in it functions for creating a local CRUD as well as with an external database (mySQL). To be improved version 2:
